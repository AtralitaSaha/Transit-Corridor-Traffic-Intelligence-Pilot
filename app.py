...
def main():
    ...
    # =============================================================================
        ...
        st.write("---")
        st.markdown(
            '<h2 style="font-size:22px; font-weight:700; color:#ffffff; margin-top:8px; margin-bottom:4px; opacity:1 !important;">Spatial Propagation Analysis</h2>',
            unsafe_allow_html=True
        )
        st.caption(
        ...
        if len(multi_corridors) > 0:
            st.write("---")
            st.markdown(
                '<h2 style="font-size:22px; font-weight:700; color:#ffffff; margin-top:8px; margin-bottom:4px; opacity:1 !important;">Empirical Verification: Root-Cause Events</h2>',
                unsafe_allow_html=True
            )
            for corr in multi_corridors:
    ...
    # =============================================================================
        ...
        st.markdown('<h1 style="color:#ffffff; font-weight:700; font-size:24px;">Hypothesis 3: Structural Choke Points & Geometric Constraints</h1>', unsafe_allow_html=True)
        
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">3. Structural Choke Points & Geometric Constraints</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[1] Infrastructure Typology Inventory Matrix</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[2] Signal Influence Friction Analysis</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[3] Road Width Lane Allocation Penalty Tracking</h2>', unsafe_allow_html=True)
    ...
    # =============================================================================
        ...
        st.markdown('<h1 style="color:#ffffff; font-weight:700; font-size:24px;">Hypothesis 6: Travel Time Predictability & Commuter Uncertainty</h1>', unsafe_allow_html=True)
        
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">6. Travel Time Predictability & Commuter Uncertainty</h2>', unsafe_allow_html=True)
    ...
    # Mathematical Statistical Assembly
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[1] Fleet Transit Network Predictability Registry</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[2] Network Buffer Time Index Performance Scale</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color:#ffffff; font-weight:600; font-size:18px;">[3] Deviation Dispersion Mismatch Tracking</h2>', unsafe_allow_html=True)
