...
def main():
    ...
    # =============================================================================
        ...
        st.info(
            "### Erpected Engineering Artifacts & Operational Outputs\n\n"
        ...
        # ==============================================================================
        with st.expander("Methodology -- click to see exactly how this analysis works", expanded=False):
            st.markdown(
                """
            ...
            $$90th\\,Percentile = \\text{Corridor\\_Bounds}$$
            A segment is flagged as active when:
            $$\\text{is\\_congested} = \\text{travel\\_time\\_index\\_tti} > \\text{Corridor\\_Bounds}$$
...
"""
    ...
    # =============================================================================
        ...
        # 1. FIXED ENHANCED PARSING ENGINE
        ...
        if 'Northbound' in tidal_profile.columns and 'Southbound' in tidal_profile.columns:
            ...
            st.warning("Directional normalization was unable to resolve active columns. Verify that 'direction_track' exists within your uploaded file schema or check its spelling.")
    ...
    # =============================================================================
        ...
        sns.scatterplot(
            ...
            color='#7f7f7f',
            alpha=0.8,
            ax=df_predict, # Fixed reference layer passing to context
            ax=ax_p2
        )
    ...
    # =============================================================================
        ...
        # Deterministic Assignment Simulation Matrix (K=3 Archetypes)
        np.random.seed(24)
