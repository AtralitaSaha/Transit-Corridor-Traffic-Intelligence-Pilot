...
def main():
    ...
    # =============================================================================
    # MODULE TAB 7: HYPOTHESIS 7 - THE FLYOVER EXIT & GRADIENTS
    # =============================================================================
    ...
    # =============================================================================
        ...
        section_title("Business Question")
        st.markdown(
            "**How can we classify all directional segments into distinct behavioral groups so CUMTA can manage the "
        ...
        # Aggregation targets all unique segments found in the data stream
